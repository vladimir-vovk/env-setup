...
before packages are loaded."
  ...
  ;; javascript format on save
  (add-hook 'js2-mode-hook
            (lambda ()
              (add-hook 'before-save-hook 'prettier-js nil 'make-it-local)))

  ;; avoid adding the replaced text to the kill ring upon pressing p
  ...
  ;; Add nvm to the PATH
  (setenv "PATH" (concat (getenv "PATH") ":/Users/vvovk/.nvm/versions/node/v20.15.1/bin/"))
  (setq exec-path (append exec-path '("/Users/vvovk/.nvm/versions/node/v20.15.1/bin/")))

  ;; Powerline separator
  (setq powerline-default-separator nil)

  ;; Associate tsx to Typescript mode
  ...
  ;; camel case motion
  (setq camel-case-motion-globally 't)
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-jump-helm-line ace-link aggressive-indent all-the-icons auto-compile
                          ...
                          clean-aindent-mode column-enforce-mode company-lua
                          company-nixos-options counsel-gtags dap-mode define-word
                          ...
                          flycheck-elsa flycheck-package ggtags golden-ratio
                          ...
                          lorem-ipsum lsp-docker lua-mode macrostep multi-line
                          nameless nix-mode nixos-options open-junk-file
                          org-superstar overseer paradox password-generator
                          pcre2el popwin quickrun rainbow-delimiters request
                          restart-emacs solarized-theme space-doc spaceline
                          spacemacs-purpose-popwin spacemacs-whitespace-cleanup
                          string-edit-at-point string-inflection symbol-overlay
                          symon term-cursor tern tide toc-org treemacs-evil
                          treemacs-icons-dired treemacs-persp treemacs-projectile
                          undo-tree uuidgen vi-tilde-fringe vim-powerline
                          volatile-highlights which-key winum writeroom-mode
                          ws-butler yaml-mode))
   '(safe-local-variable-values
     '((evil-shift-width . 2) (typescript-backend . tide) (typescript-backend . lsp)
